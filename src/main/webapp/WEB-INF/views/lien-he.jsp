...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="footer__about">
						<div class="footer__about__logo">
							<a href=""> <img style="width: 50%;" src="/ShopMV/images/logo-11.jpg" alt="">
							</a>
						</div>
						<ul>
							<li>Địa chỉ: 12, Nguyễn Văn Bảo, P4,Gò Vấp, HCM</li>
							<li>Số điện thoại: 0999999999</li>
							<li>Email: osping@gmail.com</li>
						</ul>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
					<div class="footer__widget">
						<img style="width: 25%;" src="/ShopMV/images/logo-12.jpg" alt="">
				...
				<div class="col-lg-4 col-md-12">
					<div class="footer__widget">
						<img style="width: 25%;" src="/ShopMV/images/logo-13.jpg" alt="">
						<h6>Tham gia ngay bây giờ</h6>
						<p>Nhận thông tin cập nhật qua E-mail mới nhất về cửa hàng của
  ...
  <path
									...
									height="16" fill="currentColor" class="bi bi-pinterest"
									viewBox="0 0 16 16">
  <path
