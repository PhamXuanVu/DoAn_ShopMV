							...
							method="POST">
								<div class="form-row">
									<div class="col form-group">
										<label>Họ Tên đệm </label> <input name="hoTenDem" type="text"
											class="form-control" placeholder="" value="${nguoiDung.hoTenDem }">
									</div>
									<div class="col form-group">
								...
								<div class="form-group">
									<label>Số điện thoại</label> <input name="soDienThoai"
										type="text" class="form-control" placeholder="" value="${nguoiDung.soDienThoai }">
								</div>
								<div class="col form-group">
									<label>Địa chỉ </label> <input name="diaChi" type="text"
										class="form-control" placeholder="" value="${nguoiDung.diaChi }">
								</div>
								<div class="form-group">
