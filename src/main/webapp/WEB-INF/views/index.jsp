				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="featured__controls">
							<ul>
								<li onclick="location.href='${pageContext.request.contextPath }/';" class="active" data-filter="*">Tất cả</li>
								<li onclick="location.href='${pageContext.request.contextPath }/san-pham-noi-bat/3';">Nước hoa</li>
								<li onclick="location.href='${pageContext.request.contextPath }/san-pham-noi-bat/1';">Thời trang nam</li>
								<li onclick="location.href='${pageContext.request.contextPath }/san-pham-noi-bat/2';">Thời trang nữ</li>
								<li onclick="location.href='${pageContext.request.contextPath }/san-pham-noi-bat/6';">Đồng hồ</li>
							</ul>
						</div>
					</div>
				</div>
