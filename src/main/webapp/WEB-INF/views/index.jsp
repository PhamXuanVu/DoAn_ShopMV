	...
	<section class="hero hero-normal">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					<div style="background-image: url('/ShopMV/images/banner11.jpg');"
	...
	<section class="featured spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title">
						<a style="text-decoration: none;" href="${pageContext.request.contextPath }/danhmuc/tat-ca-san-pham"><h2>Tất cả sản phẩm</h2></a>
					</div>
				</div>
			</div>
			<div class="row featured__filter">
